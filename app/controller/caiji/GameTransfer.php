...
class GameTransfer extends BaseController
{
    ...
    {
        return Db::name('ntp_api_goldengatex_supplier_games')
    ...
    private function syncData($sourceData, $backupData, $supplierData)
    {
        ...
        try {
            ...
            // 清空目标表中 api_code_set = 'GGKJ' 的数据
            Db::execute("DELETE FROM ntp_api_games WHERE api_code_set = 'GGKJ'");
            Log::info('syncData - 已清空 api_code_set = GGKJ 的数据');
